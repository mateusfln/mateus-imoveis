...
$negociotipos = $negociotiposDAO->read($_GET['id']);

if(!empty($_POST['nome'])){
    $hoje = new \DateTimeImmutable();
    $negociotipos->setNome($_POST['nome']);
    $negociotipos->setAtivo(false);
    if(!empty($_POST['ativo'])){
        $negociotipos->setAtivo($_POST['ativo']);
    }
    $negociotipos->setModificadorId(1);
    $negociotipos->setModificado($hoje);
